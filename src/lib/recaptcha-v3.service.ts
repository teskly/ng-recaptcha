...
export class ReCaptchaV3Service {
  ...
  public siteKeySub: Subject<string> = new Subject();
  public siteKeyObservable: Observable<string> = this.siteKeySub.asObservable();
  ...
  constructor(
    ...
    this.siteKeyObservable.subscribe((newKey: string) => {
      this.siteKey = newKey;
      this.init();
    });
